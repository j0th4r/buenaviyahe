    ...
    <div className="min-h-screen bg-white">
      <main className="mx-auto max-w-[430px] px-5 pb-10 pt-6">
        <header className="flex items-center justify-between py-2">
          <Link aria-label="Go back" href="/profile" className="rounded-full p-1 hover:bg-gray-100">
        ...
        <div className="mt-8 flex flex-col items-center">
          <div className="relative">
            ...
            />
            <label className="absolute bottom-1 right-1 rounded-full bg-white p-1.5 shadow-md cursor-pointer" aria-label="Change photo">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div>
            <label htmlFor="current-city" className="text-sm font-medium text-gray-700">Current city</label>
          ...
          <div>
            <label htmlFor="about" className="text-sm font-medium text-gray-700">About you</label>
            <textarea
              id="about"
              rows={4}
